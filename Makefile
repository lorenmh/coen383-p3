...
FILES=main.o customer.o seller.o seatFinder.o event.o

all: main.o customer.o seller.o seatFinder.o event.o
...
seatFinder.o: seatFinder.c seatFinder.h
	$(COMPILE) seatFinder.c
